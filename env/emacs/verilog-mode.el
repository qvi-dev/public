...
(let* ((verilog-type-font-keywords
  ...
  (setq verilog-font-lock-keywords
	(list
	 ;; fontify Ingenic define 
	 (concat "\\<IF[a-z][a-z0-9_]*")
	 (concat "\\<M[a-z][a-z0-9_]*")

	 (cons (concat "\\<BIT\\>") 
		'font-lock-type-face)
	 (cons (concat "\\<TS[a-z][a-z0-9_]*") 
		'font-lock-type-face)
	 (cons (concat "\\<TA[a-z][a-z0-9_]*") 
		'font-lock-type-face)
	 (cons (concat "\\<TU[a-z][a-z0-9_]*") 
		'font-lock-type-face)

	 (cons (concat "\\<if_[a-z][a-z0-9_]*") 
		'font-lock-type-face)
